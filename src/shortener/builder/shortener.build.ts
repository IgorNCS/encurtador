...
export class ShortenerBuilder {
  static createViewShortener(shortener: Shortener): ViewShortenerDTO {
    const { id, originalUrl, shortenedUrl, userId, clicks, createdAt, updatedAt,onlyAuthenticated } = shortener;

    return { id, originalUrl, shortenedUrl, userId, clicks, createdAt, updatedAt,onlyAuthenticated };
  }
}
